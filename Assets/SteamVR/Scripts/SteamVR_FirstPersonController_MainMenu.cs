...
public class SteamVR_FirstPersonController_MainMenu : MonoBehaviour
{
    ...
    public GameObject CameraContainer_MM;
        ...
        if (pointer.gameObject.activeSelf)
        {
            ...
            else
            {
                ...
                if(Button != null && once)
                {
                    ...
                    Button = null;
                    CameraContainer_MM.GetComponent<MainMenusController>().AssignButton(ref Button);
                    once = false;
                }
            }
        }
